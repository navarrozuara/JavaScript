$(document).ready(function() {
	...
	$("#guardarobjeto").click(function(evento) {
		...
		$("#mensaje").html('He guardado en todos los enlaces un dato llamado "miobjeto" con el valor de un objeto que es el objeto jquery de seleccionar la capa con id "capapruebas"');
	});
